<?php
/**
 * Plugin Name: Hotspot addon for elementor
 * Description: Hotspot addon for elementor  extension which includes custom widgets.
 * Plugin URI:  https://webtoptemplate
 * Version:     1.0.0
 * Author:      Kardi
 * Author URI:  github/ikardi04
 * Text Domain: wtt-hotspots
 * Domain Path: /languages
 */

namespace WttHotspot;
...
final class Wtt_Elementor_Extension {
	...
	public function i18n() {
		...
		load_plugin_textdomain( 'wtt-hotspot-block', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/hotshpot-widget.php' );


	
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \WttHotspotBlock() );
	...
	public function widget_styles() {
		...
		wp_enqueue_script('front-min-js', plugins_url( 'assets/js/frontend.js', __FILE__ ), array(), '1.0.0', true );
